                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="card bg-dark shadow stream-card">
                                <div className="card-body">
                                    ...
                                    {/* <iframe src={"http://assets.pokelink.xyz/themes/letsgo-pretty/index.html?user=" + this.state.pickels.channel + "&server=" + this.state.pickels.host + "&port=" + this.state.pickels.port}
                                        frameBorder="0"
                                        height="600"
                                        width="100%">
                                    </iframe> */}
